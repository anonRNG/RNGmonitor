...
The code reflects the experimental setup described in the paper and is provided solely for research and 
evaluation purposes. It is not intended as a production-ready or optimized implementation.
...
Users may modify parameters directly in the source file to reproduce alternative configurations.

## Execution
Run: python3 RNDevalRepeat.py
Results are printed to standard output.
A summary file is written to: sumresults_params.txt

## License
This software is provided solely for research and evaluation purposes.
Copying, modification, redistribution, sublicensing, or commercial use is not permitted 
